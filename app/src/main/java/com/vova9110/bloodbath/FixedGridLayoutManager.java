...
/**
 * A {@link androidx.recyclerview.widget.RecyclerView} implementation
...
public class FixedGridLayoutManager extends RecyclerView.LayoutManager {
    ...
    private void fillGrid(int direction, int emptyLeft, int emptyTop,
         ...
         */
        SparseArray<View> viewCache = new SparseArray<View>(getChildCount()); //Здесь начинается процесс наполнения сетки
