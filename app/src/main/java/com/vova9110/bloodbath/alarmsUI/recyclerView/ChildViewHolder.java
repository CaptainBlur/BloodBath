...
import com.vova9110.bloodbath.alarmsUI.AdjustableButton;
import com.vova9110.bloodbath.alarmsUI.AdjustableConstraintLayout;
...
public class ChildViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener{
    ...
    private final AdjustableButton timeWindow;
    private final AdjustableImageView prefFrame;
    private final FAHCallback hCallback;

    private ChildViewHolder(View view, FAHCallback c, Rect globalRect) {
        super(view);
        this.view = view;
        this.hCallback = c;

        prefFrame = view.findViewById(R.id.rv_pref_frame);
        prefFrame.makeAdjustments(globalRect);
...
//        minutePicker.setMinValue(0); minutePicker.setMaxValue(59);
    ...
    public void onClick(View v) {
        ...
        //Receiving feedback from the Handler as a return value
        boolean showBlank = hCallback.notifyBaseClick(getAdapterPosition());
        if (showBlank){
            slU.i(getAdapterPosition());
