 ...
 */
public abstract class HomieDefaultItemAnimator extends SimpleItemAnimator {
    ...
    RecyclerView.ViewHolder lastAdditionSubject;

    public abstract void onAddGroupFinished(RecyclerView.ViewHolder holder);
        ...
        animation.alpha(1).setDuration(getAddDuration())
                .setListener(new AnimatorListenerAdapter() {
                    ...
                    public void onAnimationEnd(Animator animator) {
                        ...
                        if (lastAdditionSubject!=null && holder==lastAdditionSubject){
                            onAddGroupFinished(holder);
                        }
                    }
                }).start();
    }
